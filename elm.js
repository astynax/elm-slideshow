...
Elm.SlideShow.make = function (_elm) {
   ...
   var title = F3(function (s,i,a) {    return A2($Html.div,_U.list([$Html$Attributes.$class("title")]),_U.list([A2(s,i,a)]));});
             ...
             ,_0: function () {
                ...
                _v0_2: do {
                   if (_p2.ctor === "_Tuple2" && _p2._0.ctor === "Just") {
                         if (_p2._0._0.ctor === "Forward") {
                               if (_p2._1.ctor === "_Tuple2" && _p2._1._0.ctor === "::" && _p2._1._0._1.ctor === "::") {
                                     return {ctor: "_Tuple2"
                                            ,_0: A2($List._op["::"],_p2._1._0._1._0,_p2._1._0._1._1)
                                            ,_1: A2($List._op["::"],_p2._1._0._0,_p2._1._1)};
                                  } else {
                                     break _v0_2;
                                  }
                            } else {
                               if (_p2._1.ctor === "_Tuple2" && _p2._1._1.ctor === "::") {
                                     return {ctor: "_Tuple2",_0: A2($List._op["::"],_p2._1._1._0,_p2._1._0),_1: _p2._1._1._1};
                                  } else {
                                     break _v0_2;
                                  }
                            }
   ...
   var view = F2(function (address,model) {
      var _p3 = model;
      if (_p3.ctor === "_Tuple2" && _p3._0.ctor === "::") {
            return _p3._0._0(address);
         } else {
            return $Html.text("Oops!");
         }
   });
   var init = function (slides) {
      var count = $List.length(slides);
      return {ctor: "_Tuple2",_0: A2($List.indexedMap,F2(function (idx,s) {    return s({ctor: "_Tuple2",_0: idx + 1,_1: count});}),slides),_1: _U.list([])};
   };
   var Backward = {ctor: "Backward"};
   var Forward = {ctor: "Forward"};
   var leftRight = A2($Signal.map,
   function (ev) {
      var _p4 = {ctor: "_Tuple2",_0: ev.x,_1: ev.y};
      _v2_2: do {
         if (_p4.ctor === "_Tuple2" && _p4._1 === 0) {
               switch (_p4._0)
               {case -1: return $Maybe.Just(Backward);
                  case 1: return $Maybe.Just(Forward);
                  default: break _v2_2;}
            } else {
               break _v2_2;
            }
   ...
   var slide = F4(function (header,content,_p5,address) {
      ...
      var navButton = F3(function (active,label,action) {
         ...
         active ? _U.list([$Html$Attributes.$class("nav-btn")
...
Elm.Main.make = function (_elm) {
   ...
   var slides = _U.list([$SlideShow.title(A2($SlideShow.slide,
                        "",
                        _U.list([$Html.text("Elm powered"),$SlideShow.nl,$Html.text("SlideShow"),$SlideShow.nl,$Html.text("(demo)")])))
                        ,A2($SlideShow.slide,
                        "Unordered list",
                        _U.list([$Html.text("Fruits")
                                ,$SlideShow.ul_(_U.list([$Html.text("Apple"),$Html.text("Orange"),$Html.text("Mango"),$Html.text("Tangerine")]))]))
                        ,A2($SlideShow.slide,
                        "Source code (lines)",
                        _U.list([$Html.text("Elm utilities:")
                                ,$SlideShow.ul_(A2($List.map,$SlideShow.code_,_U.list(["elm-make","elm-package","elm-reactor","elm-repl"])))]))
                        ,A2($SlideShow.slide,
                        "Source code (block)",
                        _U.list([A2($SlideShow.source,
                        "elm",
                        "import Html exposing (Html, text)\nimport Mouse\nimport Signal exposing (Signal)\n\nmain : Signal Html\nmain =\n  Signal.map (text <| toString)\n    Mouse.position")]))
                        ,$SlideShow.title(A2($SlideShow.slide,"",_U.list([$Html.text("The End")])))]);
   var main = function (_) {    return _.html;}($SlideShow.start(slides));
   return _elm.Main.values = {_op: _op,main: main,slides: slides};
};
